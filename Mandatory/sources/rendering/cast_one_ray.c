...
/*   Updated: 2025/07/27 08:29:24 by eel-garo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_horizontal_dda(t_game *game, t_dda *dda, int i)
{
	...
	dda->x_intercept = game->player.x
		+ (dda->y_intercept - game->player.y) / tan(game->rays[i].ray_angle);
...
static void	init_vertical_dda(t_game *game, t_dda *dda, int i)
{
	...
	dda->y_intercept = game->player.y
		+ (dda->x_intercept - game->player.x) * tan(game->rays[i].ray_angle);
